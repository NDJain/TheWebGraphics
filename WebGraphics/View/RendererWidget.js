$.widget("WG.scenerenderer", {
    ...
    _create: function () {
        ...
        this._camera = new THREE.PerspectiveCamera(45, size.width / size.height, 0.1, 1000);
        ...
        setInterval(function () {
            if (_this.options.scene !== undefined) {
                renderer.clear();
                renderer.render(_this.options.scene, camera);
            }
            else {
                renderer.clear();
            }
...
//# sourceMappingURL=RendererWidget.js.map