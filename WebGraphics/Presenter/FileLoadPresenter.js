var FileLoadPresenter = (function () {
    function FileLoadPresenter(appModel, renderPresenter, fileInput) {
        var that = this;
    ...
    FileLoadPresenter.prototype.ParseMolekula = function (contents) {
            ...
            if (idx > -1) {
                ...
                if (currentBlock !== undefined) {
                    if (currentBlock.indexOf("ATOM") > -1) {
                        ...
                        molekula.Atoms.push(new Atom(parseInt(data[0]), data[1], parseFloat(data[2]), parseFloat(data[3]), parseFloat(data[4])));
                    }
                        ...
                        molekula.Bonds.push(new Bond(parseInt(data[0]), parseInt(data[1]), parseInt(data[2]), y));
                    }
                }
            }
        }
    ...
    return FileLoadPresenter;
}());
//# sourceMappingURL=FileLoadPresenter.js.map